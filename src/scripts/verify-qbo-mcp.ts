...
const config: QuickBooksMcpPostingConfig | undefined = posting ? { expenseAccountId: expenseAccountId!, taxAccountId: process.env.QBO_MCP_TAX_ACCOUNT_ID?.trim(), apAccountId: process.env.QBO_MCP_AP_ACCOUNT_ID?.trim() } : undefined
