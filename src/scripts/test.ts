...
const kpiReport = buildApKpiReport([
  ...
  { ...kpiBase, runId: 'failed-resume', recordedAt: '2026-08-14T00:00:08.000Z', executionStatus: 'posted', postingStatus: 'posted', approvalPending: false, approvalState: 'approved' },
