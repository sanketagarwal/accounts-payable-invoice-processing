...
const toolResult = z.object({
  ...
  disposition: z.string().nullable().default(null), approvalPending: z.boolean(), reasons: z.array(z.string()),
...
export const invoiceChatIntakeAgent = new Agent({
  id: 'accounts-payable-agent', name: 'Accounts Payable Agent', model: process.env.INVOICE_READER_MODEL ?? 'openai/gpt-5.2',
