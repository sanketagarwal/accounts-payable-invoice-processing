...
export function makeQuickBooksProvider(client?: QboClient, billPageSize?: number): AccountingProvider {
  ...
  return assertProvider({
    ...
    vendors: adapter, purchaseOrders: adapter, billHistorySeed: () => adapter.billHistorySeed(), identityNamespaces: { vendors: 'quickbooks', purchaseOrders: 'quickbooks', purchaseOrderVendorIds: 'quickbooks', billHistoryVendorIds: 'quickbooks' },
  })
}
